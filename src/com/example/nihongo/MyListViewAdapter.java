...
public class MyListViewAdapter extends BaseAdapter {
	...
	public MyListViewAdapter(Activity ctx, List<WordBean> beanList) {
		activity = ctx;
		...
		holder.tv_jiaming.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				final AlertDialog.Builder normalDialog = new AlertDialog.Builder(
						activity);
				int lessonNum = beanList.get(position).lessonNum;
				int num = beanList.get(position).num;
				String location = "lesson:" + lessonNum + "\n" + "num:" + num;
